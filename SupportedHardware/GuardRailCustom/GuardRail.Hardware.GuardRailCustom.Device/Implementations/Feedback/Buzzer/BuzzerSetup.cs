...
public static class BuzzerSetup
{
    ...
    public static IServiceCollection AddBuzzer<TBuzzerConfiguration, TBuzzerConfigurationType, TBuzzerHardwareManager, TBuzzerManager>(
        ...
        services
            .AddSingleton(configuration.GetSection("Buzzer").Get<TBuzzerConfiguration>() ?? new TBuzzerConfiguration())
            .AddSingleton<IBuzzerConfiguration<TBuzzerConfigurationType>, TBuzzerConfiguration>()
            .AddSingleton<TBuzzerHardwareManager>()
            .AddSingleton<IBuzzerHardwareManager<TBuzzerConfigurationType>, TBuzzerHardwareManager>()
            .AddSingleton<IAsyncInit, TBuzzerHardwareManager>()
            .AddSingleton<IAsyncInit, TBuzzerManager>()
