...
namespace GuardRail.Hardware.GuardRailCustom.Device.Implementations.Input.Keypad;
...
{
    /// <summary>
    /// Adds implementations for <see cref="IKeypadConfiguration{T}"/>, <see cref="IKeypadHardwareManager{TKeypadConfigurationType}"/>, and <see cref="IKeypadInput"/> to manage and control a hardware Keypad.
    /// </summary>
    /// <remarks>
    ...
    public static IServiceCollection AddKeypad<TKeypadConfiguration, TKeypadConfigurationType, TKeypadHardwareManager, TKeypadInput>(
        ...
        services
            .AddSingleton(configuration.GetSection("Keypad").Get<TKeypadConfiguration>() ?? new TKeypadConfiguration())
            ...
            .AddSingleton<IKeypadHardwareManager<TKeypadConfigurationType>, TKeypadHardwareManager>()
            .AddSingleton<IAsyncInit, TKeypadHardwareManager>()
            .AddSingleton<TKeypadInput>()
            .AddSingleton<IKeypadInput, TKeypadInput>()
            .AddSingleton<IAsyncInit, TKeypadInput>();
