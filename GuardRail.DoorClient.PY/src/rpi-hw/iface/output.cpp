...
#include "../../../include/rpi-hw/iface/output.hpp"

namespace rpihw { // Begin main namespace

namespace iface { // Begin interfaces namespace

output::output( std::initializer_list< uint8_t > pins ) : iface::iface_base( pins ) {
...
output::output( const std::vector< uint8_t > &pins ) : iface::iface_base( pins ) {
