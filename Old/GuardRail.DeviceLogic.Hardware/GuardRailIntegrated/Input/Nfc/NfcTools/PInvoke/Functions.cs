...
internal static class Functions
{
    ...
    [DllImport("libnfc", CallingConvention = CallingConvention.Cdecl)]
    //public static extern int nfc_initiator_poll_target(IntPtr pnd, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] nfc_modulation[] pnmTargetTypes, UIntPtr szTargetTypes, byte uiPollNr, byte uiPeriod, out IntPtr pnt);
    public static extern int nfc_initiator_poll_target(
        IntPtr pnd,
        IntPtr pnmModulations,
        uint szModulations,
        byte uiPollNr,
        byte uiPeriod,
        out IntPtr pnt);
    ...
    [DllImport("libnfc", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static extern int str_nfc_target(out string buf, IntPtr pnt, bool verbose);
