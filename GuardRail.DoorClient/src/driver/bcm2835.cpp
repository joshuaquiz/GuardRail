...
#include "../../include/rpi-hw/driver/bcm2835.hpp"
...
bcm2835::bcm2835() {
	...
	m_mem_fd = open( "/dev/gpiomem", O_RDWR | O_SYNC );
	...
	m_gpio = static_cast<volatile uint32_t*>(mmap(
	...
	m_pwm = static_cast<volatile uint32_t*>(mmap(
...
bcm2835::setPullUpDown( uint8_t pin, uint8_t mode ) {
	...
	// 11 = Reserved
	reg_pullupdown = static_cast<uint32_t>(mode);
