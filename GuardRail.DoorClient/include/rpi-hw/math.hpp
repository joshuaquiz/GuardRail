...
template < typename T >
inline T floor( T x ) { return static_cast< T >( std::floor( static_cast<double>(x) ) ); }

//! Returns the nearest integer not less than `x`.
template < typename T >
inline T ceil( T x ) { return static_cast< T >( std::ceil( static_cast<double>(x) ) ); }
...
template < typename T >
inline T pow( T x, T y ) { return std::pow( static_cast<double>(x), static_cast<double>(y) ); }
...
template < typename T >
inline T log2( T x ) { return static_cast< T >( math::log( static_cast<double>(x) ) / LOG2 ); }
...
template < typename T >
inline T sin( T x ) { return static_cast< T >( std::sin( static_cast<double>(x) ) ); }

//! Returns the cosine of an angle of `x` radians
template < typename T >
inline T cos( T x ) { return static_cast< T >( std::cos( static_cast<double>(x) ) ); }

//! Returns the tangent of an angle of `x` radians
template < typename T >
inline T tan( T x ) { return static_cast< T >( std::tan( static_cast<double>(x) ) ); }

//! Returns the arctangent of `x`, expressed in radians 
template < typename T >
inline T atan( T x ) { return static_cast< T >( std::atan( static_cast<double>(x) ) ); }
