...
#ifndef RPI_HW_MATH_HPP
#define RPI_HW_MATH_HPP
...
namespace rpihw
{
    ...
    */
    namespace math
    {
        ...
        T round(T x)
        {
            return x > 0.0 ? math::floor(x + 0.5) : math::floor(x - 0.5);
        }
        ...
        T log_2(T x)
        {
            return static_cast<T>(math::log(static_cast<double>(x)) / log2);
        }
        ...
        inline size_t fast_pow2(const size_t x)
        {
            return 1 << x;
        }
    }
