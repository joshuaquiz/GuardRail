...
public sealed class LightManager : ILightManager, IDisposable
{
    ...
    public LightManager(IGpio gpio, LightConfiguration lightConfiguration, ILogger<LightManager> logger)
    {
        ...
        _logger = logger;
        LogInformation($"Opening the pins for the lights: r:{_lightConfiguration.RedPin} g:{_lightConfiguration.GreenPin}");
    ...
    private void LogInformation(string message) =>
        _logger.LogInformation("[light manager] " + message);
